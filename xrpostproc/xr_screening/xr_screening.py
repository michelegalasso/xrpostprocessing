...
spectrum_starts = 6     # minimum angle of the experimental spectrum
spectrum_ends = 22      # maximum angle of the experimental spectrum
...
gatheredPOSCARS = 'first200_POSCARS.txt'    # name of the gatheredPOSCARS file
