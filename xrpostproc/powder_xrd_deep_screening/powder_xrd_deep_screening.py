...
k_coeffs = np.arange(0.91, 1.09, 0.005)     # pressure of the experimental powder
th_pressure = 50                            # pressure of the USPEX calculation

extended_convex_hull = 'UH_50_extended_convex_hull.txt'                   # name of the extended_convex_hull file
extended_convex_hull_POSCARS = 'UH_50_extended_convex_hull_POSCARS.txt'   # name of the gatheredPOSCARS file
...
B0 = 100                            # bulk modulus
dB0 = 4                             # derivative of the bulk modulus with respect to pressure

# set to True if you are using Individuals instead of extended_convex_hull
individuals = False

analyzer = SpectrumAnalyzer(k_coeffs=k_coeffs, th_pressure=th_pressure, extended_convex_hull=extended_convex_hull,
                            extended_convex_hull_POSCARS=extended_convex_hull_POSCARS, spectrum_file=spectrum_file,
